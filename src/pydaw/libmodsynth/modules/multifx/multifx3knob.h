        ...
        float a_in1)
{
    ...
    v_cmb_run(&a_mf3->comb_filter0,
        f_clp_clip(&a_mf3->clipper, a_mf3->saturator.output0));
    v_cmb_run(&a_mf3->comb_filter1,
        f_clp_clip(&a_mf3->clipper, a_mf3->saturator.output1));
